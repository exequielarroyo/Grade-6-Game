...
namespace grade6
{
    public partial class GProducerConsumer : UserControl
    {
        ...
        private void GProducerCnsumer_Load(object sender, EventArgs e)
        {
            Shuffle();
        }
        ...
        private void AskPermissionBeforeQuite(object sender, FormClosingEventArgs e)
        {
            ...
            if (sender as Guna.UI.WinForms.GunaAdvenceButton != btnQuit && YesOrNO == DialogResult.No) e.Cancel = true;
            if (sender as Guna.UI.WinForms.GunaAdvenceButton == btnQuit && YesOrNO == DialogResult.Yes) Environment.Exit(0);
        }
